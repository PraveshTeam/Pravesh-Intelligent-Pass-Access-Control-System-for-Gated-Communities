    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // public auth endpoints (register/login/refresh/forgot-password/verify-otp/reset-password)
                .requestMatchers("/api/auth/**").permitAll()
                // Razorpay hits this directly with no JWT; verified via HMAC signature instead
                .requestMatchers("/api/payments/webhook").permitAll()
                // STOMP/WebSocket handshake (SOS alerts + notifications)
